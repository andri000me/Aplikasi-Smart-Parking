...
<body>
  <div class="container">
    ...
    <div class="input-group mb-3"  >
      <div class="input-group-text" id="basic-addon1" style="height: 38px; margin-top: 0px;">
    ...
    <div class="input-group "  >
      ...
      <input type="number" class="form-control" name="no_id" placeholder="Nomor Identitas" aria-label="Nomor Identitas" aria-describedby="basic-addon1">
    ...
    <div class="input-group mb-3"  >
      ...
      <input type="number" class="form-control" name="no_pin" placeholder="Nomor PIN" aria-label="Nomor PIN" aria-describedby="basic-addon1">
