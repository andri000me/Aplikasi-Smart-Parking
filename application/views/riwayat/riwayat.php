<body style="background-image: url(<?php echo base_url() . 'assets/img/21.jpg' ?>); background-size: 100%; background-repeat : no-repeat; position: fixed;">
    <div class="container">
        <div class="row mt-3">
            <div class="col-10">
                <h2 class="fw-bold fs-1 mx-1"><i class="fas fa-history"></i> Riwayat Parkir</h2>
            </div>
            <div class="col-1">
            ...
            ?>
                <li class="list-group-item">
                    <div class="row">
                        ...
                        <?php if ($value->status == 0) { ?>
                            <div class="col-6">
                                <button type="button" class="btn btn-danger" style="width: 100%; height: 18px; font-size: 12px; border-radius: 20px;">
                                    <p style="position: relative; margin-top: -7px;">Belum Bayar</p>
                                </button>
                            </div>
                        <?php } else if ($value->status == 1) { ?>
                            <div class="col-6">
                                <button type="button" class="btn btn-success" style="width: 100%; height: 18px; font-size: 12px; border-radius: 20px;">
                                    <p style="position: relative; margin-top: -7px;">Sudah Bayar</p>
                                </button>
                            </div>
                        <?php } ?>
                    </div>
