...
<html>
	...
	<body id="home" style="background-image: url(<?php echo base_url().'assets/img/21.jpg'?>); background-size: 100%; background-repeat : no-repeat;">
		<p style="margin-top: 80px; margin-left: 20px;">Hai, Dimas</p>
		<h3 style="position: relative; text-align: left; top:-70px; left: -50px">AYO PARKIR DENGAN AMAN</h3>
		<div id="box_info" style="position: relative; top: -90px; border-radius: 15px;">
			<p class="t"><i class="far fa-credit-card"></i>&nbsp Saldo Smart Pay</p>
			<p class="s"><b>Rp70.000</b></p>
			<div class="clear"></div>
			<hr>
			<div class="col-4">
