<body id="auth2" class="daftar">
	<form action="pembayaran.html" method="POST">
		<div class="container">
			...
			<a href="<?php echo base_url().'cetak/scan.php/?id='.$this->uri->segment('3')?>"><submit type="submit" class="btn btn-dark rounded-pill full_btn" style="width: 100%">Cetak</submit></a>
			<?php } } ?>
		</div>
	</form>
